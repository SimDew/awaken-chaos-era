 ...
 */
class HeroAbilityRepository extends ServiceEntityRepository {
    public function __construct(ManagerRegistry $registry) {
        parent::__construct($registry, HeroAbility::class);
    }
     ...
     */
    public function add(HeroAbility $entity, bool $flush = true): void {
     ...
     * @throws OptimisticLockException
     */
    public function remove(HeroAbility $entity, bool $flush = true): void {
